  ...
  try {
    ...
    let user = global.DATABASE._data.users[m.sender]
      ...
      let _prefix = plugin.customPrefix ? plugin.customPrefix : conn.prefix ? conn.prefix : global.prefix
        ...
        if (xp >100 ) m.reply('_ADITYA JATAYU☻_','```LASTSYMPHONY```') // Hehehe
        else m.exp += xp
...
conn.welcome = 'Oni-chan e yōkoso, @user👋\nSelamat datang di grup @subject💖*JANGAN LUPA INTRO*\n\n*[ SOSMED BOT ]*\nWajib di Follow!\n*Instagram:* @ADITYA JATAYU\n*Youtube:* ADITYA JATAYU'
conn.bye = 'Sayōnara😭 @user!\n\nKami tidak akan mengenang jasamu ✨\n*LAST*'
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Perintah ini hanya dapat digunakan oleh _*OWNER Last*_',
    owner: 'Perintah ini hanya dapat digunakan oleh _*Owner Bot*_!',
    mods: 'Perintah ini hanya dapat digunakan oleh _*Moderator*_ !',
    premium: 'Perintah ini hanya untuk member _*Premium*_ !\nIngin beli? Segera ketik *#premium*\nDi Instagram: *@adityajatayu*',
